...
// Keyboard
let kbd = AllunoHinpudKeyboard::new().expect("driver not installed");
...
// Mouse
let mou = AllunoHinpudMouse::new().expect("driver not installed");
...
### Keyboard (`AllunoHinpudKeyboard::new()`)
